...
do
    ...
    python main.py --num_his=1 --num_pred=1 --train_size=300 --max_epoch=300 --traffic_file=../data/stationary/h5/s$i.h5 --SE_file=data/sim/SE.txt --model_file=model/sim.pt --log_file=logs/sim_train --learning_rate=1e-3 --output_file=data/sim/output/preds$i.npz
    rm model/sim.pt
done